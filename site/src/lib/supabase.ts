// Supabase client for BébéDécrypte.
...
// ============================================
// Product data accessors (Phase 0 : return empty, Phase 1 : wire to Supabase)
// ============================================
...
export async function getProducts(): Promise<ScoredProduct[]> {
  if (!supabaseConfigured()) return [];
  // TODO Phase 1 : fetch from public.products with RLS public read.
  return [];
}
